...
describe('OrchestratorStatusStrip', () => {
  it('renders authority, broadcast, and camera status labels', async () => {
    ...
    expect(container.querySelector('[aria-label="Authority: Host live coding"]')).not.toBeNull()
    expect(container.querySelector('[aria-label="Broadcast: Local edits"]')).not.toBeNull()
    expect(container.querySelector('[aria-label="Camera: Live"]')).not.toBeNull()
