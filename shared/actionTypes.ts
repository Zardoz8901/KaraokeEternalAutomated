...
export const PLAYER_EMIT_VISUALIZER_APPLIED = 'server/PLAYER_EMIT_VISUALIZER_APPLIED'
...
export const PLAYER_VISUALIZER_APPLIED = 'status/PLAYER_VISUALIZER_APPLIED'
...
// UI
export const SOCKET_CONNECTED = 'ui/SOCKET_CONNECTED'
export const SOCKET_DISCONNECTED = 'ui/SOCKET_DISCONNECTED'
export const SOCKET_RECONNECT_FAILED = 'ui/SOCKET_RECONNECT_FAILED'
